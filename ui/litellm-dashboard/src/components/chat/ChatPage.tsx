...
import { Tooltip, Skeleton, Popover, ConfigProvider, theme as antdTheme } from "antd";
  ...
  const modelSelectorContent = (
    <div style={{ width: 280, maxHeight: 400, display: "flex", flexDirection: "column" }}>
      ...
      {selectedModels.length >= MAX_COMPARISON_MODELS && (
        <div style={{ padding: "4px 12px", fontSize: 12, color: "#8b98a5" }}>
          ...
          return (
            <button
              ...
              style={{
                ...
                width: "100%",
                padding: "7px 12px",
                background: checked ? "rgba(61,220,151,0.12)" : "transparent",
                border: "none",
            ...
            >
              <span style={{
                width: 16, height: 16, borderRadius: 3, border: `1.5px solid ${checked ? "#3ddc97" : "#232a32"}`,
                background: checked ? "#3ddc97" : "#12161b",
                display: "flex", alignItems: "center", justifyContent: "center",
                flexShrink: 0, transition: "all 0.1s",
              }}>
                {checked && <CheckOutlined style={{ fontSize: 10, color: "#0a0c0f" }} />}
              </span>
              {logo ? (
  ...
  const sidebarNavItem = (
    ...
    <Tooltip title={sidebarCollapsed ? label : undefined} placement="right" key={label}>
      <button
        ...
        onMouseEnter={(e) => {
          if (!active) (e.currentTarget as HTMLButtonElement).style.background = "#171c23";
        }}
        onMouseLeave={(e) => {
          (e.currentTarget as HTMLButtonElement).style.background = active ? "rgba(61,220,151,0.12)" : "transparent";
        }}
      >
        ...
        {!sidebarCollapsed && (
          <>
            ...
            {kbd && <span style={{ fontSize: 11, color: "#5b6670" }}>{kbd}</span>}
          </>
        )}
      </button>
    </Tooltip>
  ...
  const modelSelectorTrigger = isLoadingModels ? (
    ...
    >
      <button
        ...
        onMouseEnter={(e) => { (e.currentTarget as HTMLButtonElement).style.background = "#171c23"; }}
        onMouseLeave={(e) => { (e.currentTarget as HTMLButtonElement).style.background = "transparent"; }}
      >
        {selectedModels.length === 0 ? (
          <span style={{ color: "#5b6670" }}>Select model</span>
            ...
            {selectedModels.map((m) => {
              ...
              return (
                <span key={m} style={{
                  ...
                  padding: "2px 8px", background: "rgba(61,220,151,0.12)", borderRadius: 10,
                  fontSize: 12, color: "#3ddc97", fontWeight: 500, flexShrink: 0,
                }}>
        ...
        <DownOutlined style={{ fontSize: 10, color: "#5b6670", flexShrink: 0, marginLeft: 2 }} />
      </button>
    </Popover>
  );
  ...
  const inputBar = (inConversation: boolean) => (
    <div style={{
      ...
      <div style={{
        ...
        >
          <button style={{
            background: "none", border: "1px solid #232a32",
            borderRadius: 6, padding: "5px 10px",
            cursor: "pointer", fontSize: 14, color: "#8b98a5",
            display: "flex", alignItems: "center", gap: 4,
          }}>
            <PlusOutlined />
            {selectedMCPServers.length > 0 && (
              <span style={{ fontSize: 12, color: "#3ddc97", fontWeight: 500 }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
          {!isComparisonMode && (
            <span style={{ fontSize: 12, color: "#5b6670", maxWidth: 160, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
              {inConversation
          ...
          {isAnyStreaming ? (
            <button onClick={handleStop} style={{
              background: "none", border: "1.5px solid #232a32", borderRadius: "50%",
              width: 32, height: 32, cursor: "pointer", color: "#e6edf3",
              display: "flex", alignItems: "center", justifyContent: "center",
              flexShrink: 0, transition: "border-color 0.15s",
            }}
              onMouseEnter={(e) => { (e.currentTarget as HTMLButtonElement).style.borderColor = "#8b98a5"; }}
              onMouseLeave={(e) => { (e.currentTarget as HTMLButtonElement).style.borderColor = "#232a32"; }}
            >
              <div style={{ width: 10, height: 10, background: "#e6edf3", borderRadius: 2 }} />
            </button>
          ) : (
            <button
              ...
              style={{
                background: inputText.trim() && selectedModels.length > 0 ? "#3ddc97" : "#232a32",
                border: "none", borderRadius: 7,
                padding: "7px 16px",
                cursor: inputText.trim() && selectedModels.length > 0 ? "pointer" : "not-allowed",
                color: inputText.trim() && selectedModels.length > 0 ? "#0a0c0f" : "#5b6670",
  ...
  return (
    <ConfigProvider theme={{
      ...
      token: {
        ...
        colorBgElevated: "#171c23",
        colorBorder: "#232a32",
        colorText: "#e6edf3",
        colorTextSecondary: "#8b98a5",
        colorTextDisabled: "#5b6670",
      },
    }}>
    <div style={{
      display: "flex",
      ...
      <div style={{
          ...
          <Tooltip title={sidebarCollapsed ? "Expand sidebar" : "Collapse sidebar"} placement="right">
            <button
              ...
              style={{
                ...
                padding: 6, borderRadius: 7, color: "#8b98a5", fontSize: 16,
        ...
        <div style={{ height: 1, background: "#232a32", margin: "4px 8px", flexShrink: 0 }} />
      ...
      <div style={{ flex: 1, display: "flex", flexDirection: "column", overflow: "hidden", minWidth: 0 }}>
        ...
        <div style={{
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 4, flexShrink: 0 }}>
            <Tooltip title="Settings">
              <button style={{
                background: "none", border: "none", cursor: "pointer",
                padding: 7, borderRadius: 7, color: "#8b98a5", fontSize: 16,
                display: "flex", alignItems: "center",
              }}>
                <SettingOutlined />
              </button>
        ...
        {storageUnavailable && !storageBannerDismissed && (
          <div style={{
            background: "#1a1200", borderBottom: "1px solid #3d2e00",
            padding: "6px 20px", fontSize: 13, color: "#f59e0b",
        ...
        {/* Content area */}
        <div style={{ flex: 1, minHeight: 0, overflow: "hidden", display: "flex", flexDirection: "column", background: "#12161b" }}>
          ...
          {sidebarView === "apps" ? (
            ...
            <div style={{
              ...
              {isComparisonMode ? (
                <p style={{ margin: "-16px 0 24px", fontSize: 14, color: "#8b98a5", textAlign: "center" }}>
                ...
                <div style={{ display: "flex", gap: 8, marginTop: 14, flexWrap: "wrap", justifyContent: "center" }}>
                  {SUGGESTIONS.map((s) => (
                    <button
                      ...
                      onMouseEnter={(e) => {
                        (e.currentTarget as HTMLButtonElement).style.background = "#232a32";
                      }}
                      onMouseLeave={(e) => {
                        (e.currentTarget as HTMLButtonElement).style.background = "#171c23";
                      }}
                    >
                      {s}
                    </button>
            ...
            <div style={{
                                  ...
                                  {exchangeIdx === 0 && (
                                    <div style={{
                                      ...
                                      {logo ? (
                                        ...
                                        <div style={{ width: 18, height: 18, borderRadius: "50%", background: "#232a32", flexShrink: 0 }} />
                                      )}
                                      <span style={{ fontWeight: 600, fontSize: 12, color: "#e6edf3" }}>
                                        Response {idx + 1}
                                      </span>
                                      <span style={{
                                        fontSize: 11, color: "#5b6670",
                                  ...
                                  <div style={{ padding: "14px 16px", minHeight: 60, position: "relative" }}>
                                    ...
                                    {responseText ? (
                                      <ReactMarkdown
                                        ...
                                        components={{
                                          p: ({ children }) => <p style={{ margin: "0 0 10px", lineHeight: 1.6, fontSize: 14, color: "#e6edf3" }}>{children}</p>,
                                          code: ({ className, children }) => {
                                            const isBlock = /language-(\w+)/.exec(className || "");
                                            if (isBlock) {
                                              return (
                                                <pre style={{ background: "#0a0c0f", padding: "10px 12px", borderRadius: 6, overflow: "auto", fontSize: 13, margin: "8px 0" }}>
                                                  <code>{children}</code>
                                                </pre>
                                              );
                                            }
                                            return <code style={{ background: "#171c23", padding: "2px 5px", borderRadius: 3, fontSize: 13 }}>{children}</code>;
                                          },
                                        }}
                                      >
                                        {responseText}
                                      ...
                                      <span style={{ color: "#5b6670", fontSize: 14 }}>Generating…</span>
                                    ) : (
                                      <span style={{ color: "#5b6670", fontSize: 14 }}>—</span>
                                    )}
                                  </div>
                                </div>
                              );
              ...
              {showScrollButton && (
                <button
                  ...
                  onMouseEnter={(e) => { (e.currentTarget as HTMLButtonElement).style.background = "rgba(23,28,35,0.95)"; }}
                  onMouseLeave={(e) => { (e.currentTarget as HTMLButtonElement).style.background = "rgba(23,28,35,0.85)"; }}
